...
<template>
    <div class="w-full min-h-screen flex flex-col-reverse lg:flex-row">
        <!-- Left panel -->
        <div class="w-full lg:w-1/2 bg-[#222222] text-white p-6 md:p-12 flex flex-col justify-center items-center">
            <!-- Logo and content -->
            <div class="flex flex-col gap-4 md:gap-6">
                ...
                <p class="text-gray-300 max-w-md text-sm md:text-base">
                    Join our platform and bring your ideas to life! Sign in to access your personalized writing space,
                    collaborate with others, and share your creativity. Whether you're crafting stories, articles, or
                    insights,
                    we provide the tools to help you write and publish effortlessly.
                </p>
            </div>
