...
<template>
    <div class="max-w-1/2 h-auto flex justify-center flex-col mx-auto mt-5">
        ...
        <h3 class="text-2xl text-gray-500 pb-5 font-medium">Once our soil becomes depleted or polluted - what can be done to bring it back to good health environment</h3>
        ...
        <img src="" alt="">
        <article>
            <p>Sheila is a very talented friend of mine. There's this job she wants. And she should get it. She'd crush it. She'd literally make the company extra millions of dollars in her first 30 days there.</p><br>
            <p>But she can't get anyone at the company to talk to her.</p><br>
            <p>This is a problem. A massive problem. And from my months-long research into the current labor quagmire, it's maybe the real reason no one is getting hired.And the ironic thing is that it's also the easiest problem to fix.</p><br>
        ...
        <div>
            ...
            <div>
                ...
                <span>Helping Scientists Align Their Careers with Impact & Purpose | Founder of Climate Ages. Join my Free Newsletter: https://climateages.com/newsletter/</span>
            </div>
