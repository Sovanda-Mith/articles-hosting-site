<template>
    <div
        class="sec1_container w-full sm:pl-20 sm:pr-20 h-full pt-20 pb-20 flex"
    >
        <div
            class="sec1_subcontainer w-full h-full flex gap-14 items-center justify-center"
        >
            <div
                class="sec1_text w-[50%] flex flex-col justify-center items-start gap-7"
            >
                <h2 class="">{{ title }}</h2>
                ...
                <div class="flex gap-[31px] items-center">
                    <button
                        v-if="button1Text"
                        class="text-center bg-black text-[#ffffff] pl-[12px] pr-[12px] pt-[17px] pb-[17px] rounded-[15px]"
                    >
                        {{ button1Text }}
                    </button>
                    <p v-if="button1Text && button2Text" class="subtitle-2">
                        OR
                    </p>
                    <button
                        v-if="button2Text"
                        class="text-center text-black bg-[#ffffff] pl-[12px] pr-[12px] pt-[17px] pb-[17px] rounded-[15px] shadow-xl border-[1px] border-[#000000]"
                    >
                        {{ button2Text }}
                    </button>
                </div>
            ...
            <div class="w-[50%] flex justify-end">
                <img
                    ...
                    :src="image"
                    alt=""
                    class="sec1_img w-[500px] slide-in-right"
                />
            </div>
        </div>
    </div>
