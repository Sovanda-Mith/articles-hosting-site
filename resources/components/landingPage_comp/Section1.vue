        ...
        <div class="sec1_subcontainer w-full h-full flex gap-14 items-center justify-center">
            <div class="sec1_text w-[50%] flex flex-col justify-center items-start gap-7">
                ...
                <div class="flex gap-[31px] items-center">
                    <button v-if="button1Text" class="text-center bg-black text-[#ffffff] pl-[12px] pr-[12px] pt-[17px] pb-[17px] rounded-[15px]">
                        {{button1Text}}
                    </button>
                    <p v-if="button1Text && button2Text" class="subtitle-2">OR</p>
                    <button v-if="button2Text" class="text-center text-black bg-[#ffffff] pl-[12px] pr-[12px] pt-[17px] pb-[17px] rounded-[15px] shadow-xl border-[1px] border-[#000000]">
                        {{button2Text}}
                    </button>
                </div>
            </div>
...
export default {
    ...
    props: {
        ...
        description: {
            type: String,
            default: "Say HELLO to our Blogging page created by GIC I4-B3!! Main purpose of our website is connect YOU to the world and community of all sorts where you can share your thought FOR COMPLETELY FREE OF CHARGE"
        },
        button1Text: {
            type: String,
            default: ""
